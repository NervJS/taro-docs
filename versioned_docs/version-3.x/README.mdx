...
在 Taro 3 中可以使用完整的 [**<img title="react" src={require('@site/static/img/framework/react.png').default} className="icon_platform" width="25px" /> React**](https://react.dev/) / [**<img title="vue" src={require('@site/static/img/framework/vue.png').default} className="icon_platform" width="25px" /> Vue**](https://vuejs.org/) / [**<img title="preact" src={require('@site/static/img/framework/preact.png').default} className="icon_platform" width="25px" /> Preact**](https://preactjs.com/) / [**<img title="solid" src={require('@site/static/img/framework/solid.png').default} className="icon_platform" width="25px" /> Solid**](https://www.solidjs.com/) / [**<img title="nerv" src={require('@site/static/img/framework/nerv.png').default} className="icon_platform" width="25px" /> Nerv**](https://github.com/NervJS/nerv) 开发体验，具体请参考：
