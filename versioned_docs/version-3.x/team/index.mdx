...
- 技术委员会双周会
  ...
  - 议题：来自 Taro 下各项目中标注了 tsc-agenda 标签的事宜。会议结束后提交[会议纪要](https://tarojs.notion.site/d8e3c9c75574451d90446f19d93ee10e?v=c633d573c92747ba86317af2fd2a91c9)。每次会议可邀请非委会参加，但无投票权。
...
- 权益
  ...
  - 1个 PR 合并需至少2名合作者或1名技术委员会成员同意即可进入观察期，观察期3个月即可正式成为合作者。
- 申请方法
